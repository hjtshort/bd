...
<div class="row">
	<div class="col-lg-12">
    <a class="btn btn-primary" style="margin-bottom: 15px;" href="{{route('themdanhmuctintuc')}}">Thêm danh mục tin tức</a>
	</div>
      <div class="col-lg-12">
...
$('.delete').click(function (e) { 
    ...
    bootbox.confirm("Bạn có muốn xóa danh mục. Nếu xóa tin tức thuộc danh mục sẽ mất?", function(result){ 
