                                ...
                                <div class="col-sm-12">
                                    <form role="form" method="post" action="" enctype='multipart/form-data'>
                                        ...
                                        <div class="form-group">
                                            <label>Tiêu đề</label> 
                                        <input name="tieude" type="text" placeholder="Nhập tiêu đề bài viết" class="form-control" value="{{ old('tieude') }}">
                                                                                ...
                                                                                <div class="row">
                                                                                        <div class="col-sm-6">
                                                                                                <div class="form-group">
                                                                                                        ...
                                                                                                        <input {{ old('hienthi')==1? 'checked':'' }} type="checkbox" class="hienthi" name="hienthi"  value="1"/>
                                                                                                </div>
                                                                                        </div>
                                                                                        <div class="col-sm-6">
                                                                                                <div class="form-group">
                                                                                                        <label>Tin nổi bật</label><br>
                                                                                                        <input {{ old('noibat')==1? 'checked':'' }} type="checkbox" class="noibat" name="noibat" value="1"  />
                                                                                                </div>
                                                                                        </div>
                                                                                        <div class="col-sm-12">
                                                                                            <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                 <textarea name="noidung" id="editor1" cols="30" rows="5000">{{ old('noidung') }}</textarea>
